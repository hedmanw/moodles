 ...
 * <ul>
 *   <li>{@link HotelSystem.ScheduledEvents#getEvents <em>Events</em>}</li>
 * </ul>
 * </p>
 *
 * @see HotelSystem.HotelSystemPackage#getScheduledEvents()
 * @model
 * @generated
 */
public interface ScheduledEvents extends EObject {
	 ...
	 * @see #setEvents(Map)
	 * @see HotelSystem.HotelSystemPackage#getScheduledEvents_Events()
	...
	/**
	 * Sets the value of the '{@link HotelSystem.ScheduledEvents#getEvents <em>Events</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
