 ...
 * <ul>
 *   <li>{@link BookingImpl#getBill <em>Bill</em>}</li>
 *   <li>{@link BookingImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link BookingImpl#getReservation <em>Reservation</em>}</li>
 *   <li>{@link BookingImpl#getBookingNbr <em>Booking Nbr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
