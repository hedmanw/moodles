 ...
 * <ul>
 *   <li>{@link makeABookingImpl#getR <em>R</em>}</li>
 *   <li>{@link makeABookingImpl#getB <em>B</em>}</li>
 *   <li>{@link makeABookingImpl#getC <em>C</em>}</li>
 *   <li>{@link makeABookingImpl#getPd <em>Pd</em>}</li>
 *   <li>{@link makeABookingImpl#getBank <em>Bank</em>}</li>
 *   <li>{@link makeABookingImpl#getBm <em>Bm</em>}</li>
 *   <li>{@link makeABookingImpl#getCm <em>Cm</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
