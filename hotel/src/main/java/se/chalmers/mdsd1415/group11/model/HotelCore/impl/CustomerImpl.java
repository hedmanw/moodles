 ...
 * <ul>
 *   <li>{@link CustomerImpl#getId <em>Id</em>}</li>
 *   <li>{@link CustomerImpl#getName <em>Name</em>}</li>
 *   <li>{@link CustomerImpl#getPaymentDetails <em>Payment Details</em>}</li>
 *   <li>{@link CustomerImpl#getLoyaltyPoints <em>Loyalty Points</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
