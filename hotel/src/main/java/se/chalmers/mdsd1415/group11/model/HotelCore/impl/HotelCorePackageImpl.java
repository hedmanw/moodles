...
import se.chalmers.mdsd1415.group11.model.HotelCore.ConferenceRoom;
...
import se.chalmers.mdsd1415.group11.model.HotelCore.Hotel;
...
public class HotelCorePackageImpl extends EPackageImpl implements HotelCorePackage {
	 ...
	 * @see se.chalmers.mdsd1415.group11.model.HotelCore.HotelCorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static HotelCorePackage init() {
		if (isInited) return (HotelCorePackage)EPackage.Registry.INSTANCE.getEPackage(eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(eNS_URI, theHotelCorePackage);
