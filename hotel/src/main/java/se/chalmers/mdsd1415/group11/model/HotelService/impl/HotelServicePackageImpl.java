...
import se.chalmers.mdsd1415.group11.model.HotelService.CustomerManager;
import se.chalmers.mdsd1415.group11.model.HotelService.ExternalUser;
import se.chalmers.mdsd1415.group11.model.HotelService.HotelManager;
import se.chalmers.mdsd1415.group11.model.HotelService.HotelReceptionist;
...
import se.chalmers.mdsd1415.group11.model.HotelService.HotelStaff;
...
import se.chalmers.mdsd1415.group11.model.HotelService.IRoomTypeManager;
...
public class HotelServicePackageImpl extends EPackageImpl implements HotelServicePackage {
	 ...
	 * @see se.chalmers.mdsd1415.group11.model.HotelService.HotelServicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static HotelServicePackage init() {
		if (isInited) return (HotelServicePackage)EPackage.Registry.INSTANCE.getEPackage(eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(eNS_URI, theHotelServicePackage);
