...
public class ReservationImpl extends MinimalEObjectImpl.Container implements Reservation {
	 ...
	 * @generated
	 */
	public EList getKeyCard() {
		if (keyCard == null) {
			keyCard = new EObjectResolvingEList(KeyCard.class, this, HotelSystemPackage.RESERVATION__KEY_CARD);
		}
		return keyCard;
	}
	 ...
	 * @generated
	 */
	public EList getCostCategory() {
		if (costCategory == null) {
			costCategory = new EObjectResolvingEList(RoomType.class, this, HotelSystemPackage.RESERVATION__COST_CATEGORY);
		}
		return costCategory;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case HotelSystemPackage.RESERVATION__KEY_CARD:
				getKeyCard().clear();
				getKeyCard().addAll((Collection)newValue);
				return;
			case HotelSystemPackage.RESERVATION__SCHEDULED_EVENTS:
			...
			case HotelSystemPackage.RESERVATION__COST_CATEGORY:
				...
				getCostCategory().addAll((Collection)newValue);
				return;
			case HotelSystemPackage.RESERVATION__CHECKED_IN:
				setCheckedIn(((Long)newValue).longValue());
				return;
			case HotelSystemPackage.RESERVATION__CHECKED_OUT:
				setCheckedOut(((Long)newValue).longValue());
				return;
			case HotelSystemPackage.RESERVATION__START_DAY:
				setStartDay(((Long)newValue).longValue());
				return;
			case HotelSystemPackage.RESERVATION__END_DAY:
				setEndDay(((Long)newValue).longValue());
				return;
			case HotelSystemPackage.RESERVATION__RESPONSIBLE:
				setResponsible((String)newValue);
				return;
			case HotelSystemPackage.RESERVATION__NBR_OF_GUESTS:
				setNbrOfGuests(((Integer)newValue).intValue());
				return;
		}
