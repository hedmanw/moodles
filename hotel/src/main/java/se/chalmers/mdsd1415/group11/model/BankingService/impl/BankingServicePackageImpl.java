/**
 */
package se.chalmers.mdsd1415.group11.model.BankingService.impl;
...
import se.chalmers.mdsd1415.group11.model.BankingService.BankingServiceFactory;
...
public class BankingServicePackageImpl extends EPackageImpl implements BankingServicePackage {
	 ...
	 * @see se.chalmers.mdsd1415.group11.model.BankingService.BankingServicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BankingServicePackage init() {
		if (isInited) return (BankingServicePackage)EPackage.Registry.INSTANCE.getEPackage(eNS_URI);
		...
		EPackage.Registry.INSTANCE.put(eNS_URI, theBankingServicePackage);
