 ...
 * <ul>
 *   <li>{@link checkOutSuccessImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getKeyCards <em>Key Cards</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getR <em>R</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getB <em>B</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getBank <em>Bank</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getC <em>C</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getRm <em>Rm</em>}</li>
 *   <li>{@link checkOutSuccessImpl#getBm <em>Bm</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
