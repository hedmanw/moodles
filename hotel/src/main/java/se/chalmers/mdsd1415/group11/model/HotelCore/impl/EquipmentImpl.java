 ...
 * <ul>
 *   <li>{@link EquipmentImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EquipmentImpl extends MinimalEObjectImpl.Container implements Equipment {
	...
	protected EClass eStaticClass() {
		return HotelCorePackage.Literals.EQUIPMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelCorePackage.EQUIPMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HotelCorePackage.EQUIPMENT__NAME:
				return getName();
		}
