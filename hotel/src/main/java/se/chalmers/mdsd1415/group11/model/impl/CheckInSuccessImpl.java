 ...
 * <ul>
 *   <li>{@link CheckInSuccessImpl#getR <em>R</em>}</li>
 *   <li>{@link CheckInSuccessImpl#getK <em>K</em>}</li>
 *   <li>{@link CheckInSuccessImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link CheckInSuccessImpl#getActor <em>Actor</em>}</li>
 *   <li>{@link CheckInSuccessImpl#getBm <em>Bm</em>}</li>
 *   <li>{@link CheckInSuccessImpl#getB <em>B</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
