 ...
 * <ul>
 *   <li>{@link reserveARoomImpl#getR <em>R</em>}</li>
 *   <li>{@link reserveARoomImpl#getReservation <em>Reservation</em>}</li>
 *   <li>{@link reserveARoomImpl#getBooking <em>Booking</em>}</li>
 *   <li>{@link reserveARoomImpl#getRoomManager <em>Room Manager</em>}</li>
 *   <li>{@link reserveARoomImpl#getReservationManager <em>Reservation Manager</em>}</li>
 *   <li>{@link reserveARoomImpl#getBookingManager <em>Booking Manager</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
