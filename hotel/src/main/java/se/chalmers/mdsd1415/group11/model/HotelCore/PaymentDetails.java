 ...
 * <ul>
 *   <li>{@link PaymentDetails#getCcNumber <em>Cc Number</em>}</li>
 *   <li>{@link PaymentDetails#getCcv <em>Ccv</em>}</li>
 *   <li>{@link PaymentDetails#getExpiryMonth <em>Expiry Month</em>}</li>
 *   <li>{@link PaymentDetails#getExpiryYear <em>Expiry Year</em>}</li>
 *   <li>{@link PaymentDetails#getFirstName <em>First Name</em>}</li>
 *   <li>{@link PaymentDetails#getLastName <em>Last Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see HotelCorePackage#getPaymentDetails()
 * @model
 * @generated
 */
public interface PaymentDetails extends EObject {
	 ...
	 * @see HotelCorePackage#getPaymentDetails_CcNumber()
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getCcNumber <em>Cc Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setCcv(String)
	 * @see HotelCorePackage#getPaymentDetails_Ccv()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	String getCcv();
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getCcv <em>Ccv</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getPaymentDetails_ExpiryMonth()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	int getExpiryMonth();
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getExpiryMonth <em>Expiry Month</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getPaymentDetails_ExpiryYear()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	int getExpiryYear();
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getExpiryYear <em>Expiry Year</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getPaymentDetails_FirstName()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	String getFirstName();
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getFirstName <em>First Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getPaymentDetails_LastName()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	String getLastName();
	...
	/**
	 * Sets the value of the '{@link PaymentDetails#getLastName <em>Last Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
