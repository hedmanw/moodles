 ...
 * @generated
 */
public class BankingServiceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BankingServicePackage.ADMINISTRATOR_PROVIDES: {
