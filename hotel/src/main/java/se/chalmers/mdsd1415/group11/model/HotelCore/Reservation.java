 ...
 * <ul>
 *   <li>{@link Reservation#getTab <em>Tab</em>}</li>
 *   <li>{@link Reservation#getKeyCard <em>Key Card</em>}</li>
 *   <li>{@link Reservation#getScheduledEvents <em>Scheduled Events</em>}</li>
 *   <li>{@link Reservation#getRoom <em>Room</em>}</li>
 *   <li>{@link Reservation#getCostCategory <em>Cost Category</em>}</li>
 *   <li>{@link Reservation#getCheckedIn <em>Checked In</em>}</li>
 *   <li>{@link Reservation#getCheckedOut <em>Checked Out</em>}</li>
 *   <li>{@link Reservation#getStartDay <em>Start Day</em>}</li>
 *   <li>{@link Reservation#getEndDay <em>End Day</em>}</li>
 *   <li>{@link Reservation#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link Reservation#getNumberOfGuests <em>Number Of Guests</em>}</li>
 * </ul>
 * </p>
 *
 * @see HotelCorePackage#getReservation()
 * @model
 * @generated
 */
public interface Reservation extends EObject {
	 ...
	 * @see #setTab(Tab)
	 * @see HotelCorePackage#getReservation_Tab()
	...
	/**
	 * Sets the value of the '{@link Reservation#getTab <em>Tab</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link KeyCard}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see HotelCorePackage#getReservation_KeyCard()
	 * @model ordered="false"
	 * @generated
	 */
	 ...
	 * @see HotelCorePackage#getReservation_ScheduledEvents()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Reservation#getScheduledEvents <em>Scheduled Events</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRoom(Room)
	 * @see HotelCorePackage#getReservation_Room()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	Room getRoom();
	...
	/**
	 * Sets the value of the '{@link Reservation#getRoom <em>Room</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link RoomType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see HotelCorePackage#getReservation_CostCategory()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see HotelCorePackage#getReservation_CheckedIn()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	long getCheckedIn();
	...
	/**
	 * Sets the value of the '{@link Reservation#getCheckedIn <em>Checked In</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getReservation_CheckedOut()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	long getCheckedOut();
	...
	/**
	 * Sets the value of the '{@link Reservation#getCheckedOut <em>Checked Out</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getReservation_StartDay()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	long getStartDay();
	...
	/**
	 * Sets the value of the '{@link Reservation#getStartDay <em>Start Day</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setEndDay(long)
	 * @see HotelCorePackage#getReservation_EndDay()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	long getEndDay();
	...
	/**
	 * Sets the value of the '{@link Reservation#getEndDay <em>End Day</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getReservation_Responsible()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Reservation#getResponsible <em>Responsible</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see HotelCorePackage#getReservation_NumberOfGuests()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Reservation#getNumberOfGuests <em>Number Of Guests</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
