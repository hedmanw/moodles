...
public class AdministratorDemo {
	...
	public static void main(String args[]) {
		...
		try {
			...
			// Add new credit card
			if (bankingAdmin.addCreditCard("11000000", "000", 11, 16, "Peter",
					"Pan")) {
			...
			// Get current Balance
			double resultBalance = bankingAdmin.getBalance("11000000", "000",
					11, 16, "Peter", "Pan");
			...
			// Make a deposit
			resultBalance = bankingAdmin.makeDeposit("11000000", "000", 11, 16,
					"Peter", "Pan", 25.50);
			if (resultBalance != -1.0) {
			...
			if (bankingAdmin.removeCreditCard("11000000", "000", 11, 16, "Peter",
					"Pan")) {
