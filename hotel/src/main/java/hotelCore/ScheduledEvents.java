 ...
 * <ul>
 *   <li>{@link hotelCore.ScheduledEvents#getEvents <em>Events</em>}</li>
 * </ul>
 * </p>
 *
 * @see hotelCore.HotelCorePackage#getScheduledEvents()
 * @model
 * @generated
 */
public interface ScheduledEvents extends EObject {
	 ...
	 * @see #setEvents(Map)
	 * @see hotelCore.HotelCorePackage#getScheduledEvents_Events()
	...
	/**
	 * Sets the value of the '{@link hotelCore.ScheduledEvents#getEvents <em>Events</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
