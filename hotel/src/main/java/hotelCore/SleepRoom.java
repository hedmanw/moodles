 ...
 * <ul>
 *   <li>{@link hotelCore.SleepRoom#getNbrOfBeds <em>Nbr Of Beds</em>}</li>
 * </ul>
 * </p>
 *
 * @see hotelCore.HotelCorePackage#getSleepRoom()
 * @model
 * @generated
 */
public interface SleepRoom extends RoomType {
	 ...
	 * @see hotelCore.HotelCorePackage#getSleepRoom_NbrOfBeds()
	...
	/**
	 * Sets the value of the '{@link hotelCore.SleepRoom#getNbrOfBeds <em>Nbr Of Beds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
