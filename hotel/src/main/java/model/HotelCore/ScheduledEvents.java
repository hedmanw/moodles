 ...
 * <ul>
 *   <li>{@link model.HotelCore.ScheduledEvents#getEvents <em>Events</em>}</li>
 * </ul>
 * </p>
 *
 * @see model.HotelCore.HotelCorePackage#getScheduledEvents()
 * @model
 * @generated
 */
public interface ScheduledEvents extends EObject {
	 ...
	 * @see #setEvents(Map)
	 * @see model.HotelCore.HotelCorePackage#getScheduledEvents_Events()
	...
	/**
	 * Sets the value of the '{@link model.HotelCore.ScheduledEvents#getEvents <em>Events</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
