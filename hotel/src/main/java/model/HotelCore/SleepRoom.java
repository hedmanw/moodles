 ...
 * <ul>
 *   <li>{@link model.HotelCore.SleepRoom#getNbrOfBeds <em>Nbr Of Beds</em>}</li>
 * </ul>
 * </p>
 *
 * @see model.HotelCore.HotelCorePackage#getSleepRoom()
 * @model
 * @generated
 */
public interface SleepRoom extends RoomType {
	 ...
	 * @see model.HotelCore.HotelCorePackage#getSleepRoom_NbrOfBeds()
	...
	/**
	 * Sets the value of the '{@link model.HotelCore.SleepRoom#getNbrOfBeds <em>Nbr Of Beds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
