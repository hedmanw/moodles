...
import model.HotelCore.KeyCard;
import model.HotelCore.Reservation;
import model.HotelCore.Room;
import model.HotelCore.RoomType;
import model.HotelCore.ScheduledEvents;
import model.HotelCore.Tab;
 ...
 * <ul>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getTab <em>Tab</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getKeyCard <em>Key Card</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getScheduledEvents <em>Scheduled Events</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getCostCategory <em>Cost Category</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getCheckedIn <em>Checked In</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getCheckedOut <em>Checked Out</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getStartDay <em>Start Day</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getEndDay <em>End Day</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link model.HotelCore.impl.ReservationImpl#getNumberOfGuests <em>Number Of Guests</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
