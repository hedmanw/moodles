 ...
 * <ul>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getCcNumber <em>Cc Number</em>}</li>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getCcv <em>Ccv</em>}</li>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getExpiryMonth <em>Expiry Month</em>}</li>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getExpiryYear <em>Expiry Year</em>}</li>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link model.HotelCore.impl.PaymentDetailsImpl#getLastName <em>Last Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PaymentDetailsImpl extends MinimalEObjectImpl.Container implements PaymentDetails {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelCorePackage.PAYMENT_DETAILS___GET_CC_V:
				return getCcV();
		}
