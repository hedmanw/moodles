...
import model.HotelCore.Equipment;
 ...
 * <ul>
 *   <li>{@link model.HotelCore.impl.RoomImpl#getRoomNumber <em>Room Number</em>}</li>
 *   <li>{@link model.HotelCore.impl.RoomImpl#getRoomType <em>Room Type</em>}</li>
 *   <li>{@link model.HotelCore.impl.RoomImpl#isCleaned <em>Cleaned</em>}</li>
 *   <li>{@link model.HotelCore.impl.RoomImpl#getEquipment <em>Equipment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomImpl extends MinimalEObjectImpl.Container implements Room {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelCorePackage.ROOM___ADD_ROOM_TYPE__ROOMTYPE:
				addRoomType((RoomType)arguments.get(0));
				return null;
			case HotelCorePackage.ROOM___REMOVE_ROOM_TYPE__ROOMTYPE:
				removeRoomType((RoomType)arguments.get(0));
				return null;
			case HotelCorePackage.ROOM___ADD_EQUIPMENT_TO_ROOM__STRING:
				addEquipmentToRoom((String)arguments.get(0));
				return null;
			case HotelCorePackage.ROOM___REMOVE_EQUIPMENT_ITEM__STRING:
