/**
 */
package bankingService.impl;

import bankingService.AdministratorProvides;
import bankingService.BankComponent;
import bankingService.BankingServiceFactory;
...
public class BankingServicePackageImpl extends EPackageImpl implements BankingServicePackage {
	 ...
	 * @see bankingService.BankingServicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
