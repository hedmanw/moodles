...
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking {
	...
	public EList<Reservation> getReservation() {
		if (reservation == null) {
			reservation = new EObjectResolvingEList<Reservation>(Reservation.class, this, HotelSystemPackage.BOOKING__RESERVATION);
		}
		return reservation;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelSystemPackage.BOOKING___GET_RESERVATIONS:
				return getReservations();
			case HotelSystemPackage.BOOKING___ADD_RESERVATION__RESERVATION:
				addReservation((Reservation)arguments.get(0));
				return null;
			case HotelSystemPackage.BOOKING___REMOVE_RESERVATION__RESERVATION:
				removeReservation((Reservation)arguments.get(0));
				return null;
			case HotelSystemPackage.BOOKING___CHANGE_CUSTOMER__CUSTOMER:
