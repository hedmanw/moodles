...
public class TabImpl extends MinimalEObjectImpl.Container implements Tab {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelSystemPackage.TAB___ADD_ITEM_TO_TAB__STRING_DOUBLE:
				addItemToTab((String)arguments.get(0), (Double)arguments.get(1));
				return null;
			case HotelSystemPackage.TAB___GET_TOTAL_COST:
				return getTotalCost();
			case HotelSystemPackage.TAB___REMOVE_TAB_ITEM__STRING:
				removeTabItem((String)arguments.get(0));
				return null;
			case HotelSystemPackage.TAB___GET_ALL:
				getAll();
				return null;
		}
