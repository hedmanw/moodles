...
public class BillImpl extends MinimalEObjectImpl.Container implements Bill {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelSystemPackage.BILL___ADD_TO_BILL__DOUBLE:
				addToBill((Double)arguments.get(0));
				return null;
			case HotelSystemPackage.BILL___IS_PAID:
				return isPaid();
			case HotelSystemPackage.BILL___REMOVE_FROM_BILL__DOUBLE:
				removeFromBill((Double)arguments.get(0));
				return null;
			case HotelSystemPackage.BILL___LEFT_TO_PAY:
				return leftToPay();
			case HotelSystemPackage.BILL___PAY__DOUBLE:
