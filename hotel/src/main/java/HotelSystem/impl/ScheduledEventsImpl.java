...
public class ScheduledEventsImpl extends MinimalEObjectImpl.Container implements ScheduledEvents {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case HotelSystemPackage.SCHEDULED_EVENTS___ADD_EVENT__STRING_LONG:
				addEvent((String)arguments.get(0), (Long)arguments.get(1));
				return null;
			case HotelSystemPackage.SCHEDULED_EVENTS___UPDATE_EVENT__STRING_LONG:
				updateEvent((String)arguments.get(0), (Long)arguments.get(1));
				return null;
			case HotelSystemPackage.SCHEDULED_EVENTS___DELETE_EVENT__STRING:
