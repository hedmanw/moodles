...
class CheckOutTest extends HotelBaseSpecification {
    ...
    def setup() {
        ...
        AdministratorRequires.instance().addCreditCard("0987123498762345", "345", 12, 15, "herp", "derp")
        AdministratorRequires.instance().makeDeposit("0987123498762345", "345", 12, 15, "herp", "derp", 100000000)
